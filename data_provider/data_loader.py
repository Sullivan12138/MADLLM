...
class NABSegLoader(Dataset):
    def __init__(self, root_path, win_size, step=1, flag="train"):
        ...
        train_data = np.load(os.path.join(root_path, 'ec2_request_latency_system_failure_train.npy'))
        test_data = np.load(os.path.join(root_path, 'ec2_request_latency_system_failure_test.npy'))
        labels = np.load(os.path.join(root_path, 'ec2_request_latency_system_failure_labels.npy'))
...
class UCRSegLoader(Dataset):
    def __init__(self, root_path, win_size, step=1, flag="train"):
        ...
        train_data = np.load(os.path.join(root_path, '136_train.npy'))
        test_data = np.load(os.path.join(root_path, '136_test.npy'))
        labels = np.load(os.path.join(root_path, '136_labels.npy'))
